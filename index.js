...
const unfundedGamesText = `There ${unfundedGamesCount === 1 ? "is" : "are"} currently ${unfundedGamesCount} game${unfundedGamesCount === 1 ? "" : "s"} that remain${unfundedGamesCount === 1 ? "s" : ""} unfunded.`;
// descriptionContainer.textContent = unfundedGamesText;

// create a new DOM element containing the template string and append it to the description container
const newParagraph = document.createElement('p');
newParagraph.textContent = unfundedGamesText;
